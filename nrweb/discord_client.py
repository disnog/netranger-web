...
class DiscordOAuth:
    ...
    def exchange_code(self, code: str) -> DiscordToken:
    ...
    def get_user(self, token: DiscordToken) -> DiscordUser:
        ...
        return DiscordUser(
            ...
            discriminator=data.get("discriminator"),  # None for new username system
...
class DiscordAPI:
    ...
    def get_guild_member(self, guild_id: str, user_id: str) -> Optional[dict[str, Any]]:
    ...
    def execute_webhook(self, webhook_id: str, webhook_token: str, content: str) -> None:
        """Execute a webhook."""
        resp = self._http.post(
    ...
    def delete_webhook(self, webhook_id: str, webhook_token: str) -> None:
        """Delete a webhook."""
